...
use alloy_sol_types::{self, eip712_domain, sol, SolCall, SolStruct, SolValue};
...
where
    S: Signer<PrimitiveSignature> + Sync + Send,
{
...
fn get_v_incremented(signature: &PrimitiveSignature) -> u8 {
